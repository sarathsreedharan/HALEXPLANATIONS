...
class DCKParser:
    ...
    def extract_while_loop(self, stripped_line, c_index, parent_node, LAST_STEP_LABEL=""):
        ...
        curr_node.succ_map["END_OF_LOOP_ITERATION"] = initial_node

        final_node = self.add_a_child_node(test_node, "END_OF_WHILE_LOOP")
        print ("Added END_OF_WHILE_LOOP", initial_node.succ_map)
        return c_index, final_node


    def extract_if_condition(self, stripped_line, c_index, parent_node,LAST_STEP_LABEL=""):
...
if __name__ == '__main__':
    DC = DCKParser('../../domains/rover/dck_scenario/foil1')
