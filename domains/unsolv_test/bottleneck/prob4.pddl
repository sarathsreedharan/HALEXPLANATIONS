(define (problem grid-prob-5-1)
  (:domain Resources)
  (:objects
    p0 p1 p2 p3 p4 - pers
    loc-0-0 loc-0-1 loc-0-2 loc-0-3 loc-0-4 loc-1-0 loc-1-1 loc-1-2 loc-1-3 loc-1-4 loc-2-0 loc-3-0 loc-3-1 loc-3-2 loc-3-3 loc-3-4 loc-4-0 loc-4-1 loc-4-2 loc-4-3 loc-4-4 - loc
  )
  (:init
    (person p0)
    (person p1)
